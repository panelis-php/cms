...
use Panelis\Cms\Http\Middleware\RegisterNavigations;
    ...
    public function panel(Panel $panel): Panel
    {
        ...
        return $panel
            ...
            ->brandLogo(function (): ?string {
                return filled(config('app.logo')) && config('app.use_logo_in_panel')
                    ? Storage::url(config('app.logo'))
                    : null;
            })
            ->favicon(function (): ?string {
                return filled(config('app.favicon')) ? Storage::url(config('app.favicon')) : null;
            })
